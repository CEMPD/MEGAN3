...
!=======================================================================
      ...
      REAL,PARAMETER :: SolarConstant       = 1367    ! Solar constant [W/m2]
      REAL,PARAMETER :: WaterAirRatio       = 18.016/28.97 ! Ratio between water and air molecules

!F    REAL,  PARAMETER :: SolarConstant       = 1367    ! Solar constant [W/m2]
!F    REAL , PARAMETER :: CONVERTWM2TOUMOLM2S = 4.5 ,                   &
!F                       SOLARCONSTANT = 1367 ,                        &
!F                      WATERAIRRATIO = 18.016/28.97
...
! LOCAL VARIBLES            
      REAL :: sindelta , cosdelta , a , b ,  D, R
      ...
      REAL, PARAMETER :: JD0 = 2451545.0 ! True Julian day for January 1, 2000
...
! FSB calculate Right Ascension of the sun
      ...
      RA =atan2(cosepsilon * sinlamda, coslamda  )  * RADCONV ! RA now in hours
...
! *** calculate solar distance [ Astronomical Units ]
...
!ooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo
      ...
      SUBROUTINE CANOPYRAD(Distgauss,Layers,Lai,Sinbeta,Qbeamv,Qdiffv,  &
                          Qbeamn,Qdiffn,Cantype,Canopychar,Sunfrac,    &
...
! ///////////////////////////////////////////////////////////////////////////        
      ...
      SUBROUTINE MEGCANOPY( NCOLS, NROWS, LAYERS, YEAR, DOY, ZTIME,         &
...
! FSB Start code        
! FSB generate PPFD as done in MEGCAN
!         PPFD = 4.5 * PAR
...
! FSB The logic here is changed from the original MEGCAN  to trap the
!      invalid total CT and LAIc  earlier. 
!           IF (TotalCT .EQ. 0.0 .AND. LAIc(I,J) .EQ. 0.0) THEN
...
!             RETURN
!           END IF ! CHECK ON when both CT and LAI are valid
...
! FSB use better solar position codes here than used in MEGCAN.
              ...
              Call  get_BETA( JDAY, Lat(I,J), Hour, Beta, Sinbeta, Eccentricity ) 
...
SUBROUTINE MEGVEA(NCOLS,NROWS, LAYERS, YEAR, DOY, ZTIME,            &
                    LAIp, LAIc, LDF_in, GAMSM, MaxT, MinT,          &
...
! INPUT VARIABLES
    ...
    REAL, INTENT(IN)     ::  GAMSM       ( NCOLS, NROWS )
...
! OUTPUT VARIABLES
    ...
    REAL, INTENT(OUT)     :: NON_DIMGARMA (NCOLS, NROWS, LAYERS)
...
! ///////////////////////////////////////////////////////////////////////////
      SUBROUTINE MEGVSA (IDATE,ITIME,NCOLS,NROWS,SLTYP, CTF,LAIc, LAT,       &
